    ...
    <>
      ...
      <div className="bg-white dark:bg-gray-800 dark:text-gray-100">
        <div className="container mx-auto grid grid-cols-1 gap-12 px-4 py-16 lg:grid-cols-2 lg:px-8 lg:py-32 xl:max-w-7xl">
          <div className="flex items-center text-center lg:text-left">
            <div className="space-y-8">
              ...
              <div>
                ...
                <h2 className="mb-1 text-4xl font-black text-black dark:text-white">
                  Coming{" "}
                  <span className="text-rose-600 dark:text-rose-500">Soon</span>
                  !
                </h2>
                <h3 className="text-xl font-medium leading-relaxed text-gray-700 dark:text-gray-300">
                  Ditch the paper, share with flair! Digicard
                </h3>
              </div>
              {/* END Heading */}
          ...
          <div className="flex items-center text-rose-500 lg:justify-end">
            <svg
