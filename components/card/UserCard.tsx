        ...
        >
          <div className=" flex flex-col items-center space-y-2">
            ...
            <div className="text-center">
              <h3 className="whitespace-nowrap mt-2 h2-bold text-light900_dark300">
                {data.fullName}
              </h3>
          ...
          <div className="p-6 grid grid-cols-2 capitalize paragraph-regular gap-2 content-center place-content-evenly">
            <DetailBadge
            ...
            />
            <div className="col-span-full max-w-xs gap-2 justify-items-center mx-auto">
              <div className="py-2">
                <DetailBadge
                  detail={data.email}
            ...
            <div className="col-span-full max-w-xs text-clip text-wrap  justify-items-center mt-4 md:mt-11 mx-auto ">
              <span className=" capitalize h2-bold text-gray-900 dark:text-gray-50">
                About {data.companyName}
              </span>
              <p className="paragraph-regular  text-balance  my-2">
                {data.aboutCompany}
              </p>
            </div>
          </div>
